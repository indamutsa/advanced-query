...
files=(
  "monstache-pod.yaml"
  "monstache-service.yaml"
  "persistence-api-claim0-persistentvolumeclaim.yaml"
  "persistence-api-claim1-persistentvolumeclaim.yaml"
  "persistence-api-deployment.yaml"
  "persistence-api-service.yaml"
  "query-engine-deployment.yaml"
  "query-engine-service.yaml"
  "setup-rs-deployment.yaml"  
)
...
files2=(
  ...
  "mongos1-claim0-persistentvolumeclaim.yaml"
  "mongos1-service.yaml"
  "mongos2-pod.yaml"
  "mongos2-service.yaml"
)
