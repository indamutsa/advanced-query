...
echo "Kubernetes manifest written to mongodb-shard1.yaml"
...
echo "Kubernetes manifest written to mongodb-shard2.yaml"
...
echo "Kubernetes manifest written to mongodb-routers.yaml"
...
echo "Created logstash deployment and service..."


cat <<EOF > 5-kibana.yaml
apiVersion: apps/v1
kind: Deployment
metadata:
  name: kibana
...
echo "Created kibana deployment and service..."


cat <<EOF > 6-filebeat-daemonset.yaml
apiVersion: apps/v1
kind: DaemonSet
metadata:
  name: filebeat
...
echo "Created filebeat daemonset deployment..."

cat <<EOF > 7-persistence-api-deployment.yaml
---
apiVersion: apps/v1
kind: Deployment
metadata:
...
echo "Created persistence-api deployment and service..."

cat <<EOF > 8-query-engine-deployment.yaml
---
apiVersion: apps/v1
kind: Deployment
metadata:
...
echo "Created query-engine deployment and service..."

cat <<EOF > 9-frontend-search-deployment.yaml
---
apiVersion: apps/v1
kind: Deployment
metadata:
...
echo "Created frontend-search deployment and service..."

cat << EOF > 10-monstache-deployment.yaml
apiVersion: apps/v1
kind: Deployment
metadata:
...
echo "Created monstache deployment and service..."